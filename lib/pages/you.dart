        ...
        child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Center(child: Text("Return to Homepage",)),
              ),SizedBox(height: 10,),
              Divider( thickness: 5),
              SizedBox(height: 10,),
              ...
              Container(
                ...
                child: Center(child: Text("Visit Buy Again",)),
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child:Column(children: [Text("Cashback earned"),
                  Text("0 Rs")
                  ],) ),
                  Container(width: size.width * 0.3,
                  child: Column(children: [Text("Reward Points"),
                  Text("0 points")]
                                 ) 
                                 ),
                  Container(width: size.width * 0.3,
                  child: Column(
                    children: [Text("Scratch Cards"),
                    Text("0  cards")]
                  ),)
                  ],
                                 ),
