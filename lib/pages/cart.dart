...
class _CartState extends State<Cart> {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(child: SingleChildScrollView(child: 
    Column(crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(height: 35,
            ...
            SizedBox(height: 7,),
            Row(children: [
              SizedBox(child: Icon(Icons.info,color: Colors.blue)),
              SizedBox(width: 5,),
            ...
            Container(
              ...
              ),child: Center(child: Text("Proceed to Buy")),
  ...
  children: [
    ...
    Expanded(
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, 
        ...
        Container(height: 200,width: size.width*0.9,
            ...
            children: [
              Row(children: [
                ...
                child: Column(children: [
                  CircleAvatar(child: Icon(Icons.lock_outline,size: 30,color: Colors.grey,)),
